    ...
    public partial class TaxiFarePrediction
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"vendor_id", @"vendor_id"),new InputOutputColumnPair(@"payment_type", @"payment_type")})      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastTree(new FastTreeRegressionTrainer.Options(){NumberOfLeaves=32768,MinimumExampleCountPerLeaf=5,NumberOfTrees=3104,MaximumBinCountPerFeature=1024,LearningRate=1F,FeatureFraction=0.793591090036893F,LabelColumnName=@"fare_amount",FeatureColumnName=@"Features"}));
